...
//            List<String> lines =
//                Files.readAllLines(
//                    rootPath.resolve(Paths.get("templates", "z-report.txt")), Charset.defaultCharset());
//
...
//                line =
//                    line.replaceAll(
//                        "\\{date\\}", DateTime.getFormatedDate("dd.MM.yyyy HH:mm:ss", zReport.getDate()));
...
//            List<String> lines =
//                Files.readAllLines(
//                    rootPath.resolve(Paths.get("templates", "receipt.txt")), Charset.defaultCharset());
//
//            String receipt = "";
//            for (String line : lines) {
//                line = line.replaceAll("\\{receiptRows\\}", getRecieptRows(posReceipt));
//                line = line.replaceAll("\\{totalDiscountSum\\}", "" + posReceipt.getTotalDiscountSum());
//                line =
//                    line.replaceAll("\\{totalSum\\}", "" + POSUtil.getReceiptSum(posReceipt.getReceipt()));
...
//                        ""
//                            + Money.SUBSTRACT(
//                            posReceipt.getCash(), POSUtil.getReceiptSum(posReceipt.getReceipt())));
...
//            List<String> lines =
//                Files.readAllLines(
//                    rootPath.resolve(Paths.get("templates", "receipt_money_deposition.txt")),
